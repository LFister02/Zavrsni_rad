...
namespace tello_joy
{
  ...
  constexpr int JOY_BUTTON_HANDSFREE = 0;   // A tipka - koristi se za uključivanje/isključivanje kontrole nad dronom
  constexpr int JOY_BUTTON_STOP = 2;        // X tipka - koristi se za sigurnosno zaustavljanje drona
  ...
  private:
    ...
    rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr stop_tracker_pub_;
    ...
    const int joy_button_input = JOY_BUTTON_HANDSFREE;
    const int joy_button_stop_ = JOY_BUTTON_STOP;

    bool enable_joy_input;
  };

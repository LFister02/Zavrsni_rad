...
class CrtaMapNode(Node):
    def __init__(self):
        super().__init__('tello_map_real')  
        ...
        self.start = None
        self.max_z = int(8.0 * self.resolution // self.resolution)
        ...
        self.load_voxels('putanja_do_CSV_datoteke')
    ...
    def start_callback(self):
        try:
            ...
            self.get_logger().info(f"Start pozicija dobivena iz tf: ({x},{y},{z})")
            return (x, y, z)
    ...
    def goal_callback(self, msg):
        try:
            ...
            z = int(6.0 * self.resolution // self.resolution)
            ...
            self.publish_sphere(self.goal, 101, (1.0, 0.0, 0.0))   # crveno - cilj
    ...
    def run_astar_with_new_goal(self):
        self.start = self.start_callback()
